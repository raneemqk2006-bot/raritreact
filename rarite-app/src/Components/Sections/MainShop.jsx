...
export default function MainShop() {
  ...
  const products = [
    ...
    },
    {
      ...
      desc: 'SKIN1004 Hyalu-Cica Water-Fit Sun Serum SPF 50 PA++++ | Lightweight Korean Sunscreen for All Skin Types...',
      price: '13.21 JOD',
      ...
      <section className="hero-section text-center py-4">
        ...
        <nav className="navbar style-nav px-3 py-2 mt-3" style={{ backgroundColor: 'rgb(201, 201, 199)' }}>
          <div className="container-fluid d-flex justify-content-between align-items-center">
            ...
            <Link to="/cart" className="text-dark position-relative text-decoration-none padding-20px fs-4">
              ...
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body d-flex flex-column justify-content-between">
                  ...
                  <div className="mt-3">
                    ...
                    <h5 className="text-primary text-center m-0">{product.price}</h5>
                  </div>
                </div>
              </div>
            </div>
